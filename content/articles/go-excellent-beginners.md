...
Finally, errors help beginners understand how to structure programs. You'll often hear phrases like "let the caller handle the error", when you first start programming in Go; that can be pretty confusing, what or who is a caller? What do you mean by "handle"? Why should they, whoever the are, handle the error and not my function? Working through these questions actually helps you to understand how to structure programs as a whole.
...
Even though Go has these deviations, the process of learning the language has been enjoyable so far. I am moving on to building side projects in Go this year and feel prepared due to the documentation, the resources available online and the community surrounding the language.